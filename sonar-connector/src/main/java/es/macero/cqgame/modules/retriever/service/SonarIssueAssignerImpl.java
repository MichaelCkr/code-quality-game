...
@Service
@Component
public class SonarIssueAssignerImpl implements SonarIssueAssigner {
	...
	@Autowired
	public SonarIssueAssignerImpl(final SonarServerConfigurationService configurationService, final RestTemplate restTemplate) {
